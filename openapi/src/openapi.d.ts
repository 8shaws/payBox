...
export interface components {
  schemas: {
    ...
    TransactionSendQuery: {
      ...
      cluster?:
        | components["schemas"]["EthCluster"]
        | components["schemas"]["Cluster"]
        | components["schemas"]["BitcoinCluster"]
        | components["schemas"]["USDCCluster"];
    };
    TxnGetQueryByHash: {
      network?: components["schemas"]["Network"];
      sign?: string;
      ...
      200: {
        ...
        content: {
          "application/json": {
            ...
            status?: "ok";
            signature?:
              | components["schemas"]["SolTransactionData"]
              | components["schemas"]["EthTxnResponse"];
          };
        };
      };
