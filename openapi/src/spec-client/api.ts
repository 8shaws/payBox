...
export type BitcoinCluster =
  (typeof BitcoinCluster)[keyof typeof BitcoinCluster];
...
export type CreateAddress200ResponseStatusEnum =
  (typeof CreateAddress200ResponseStatusEnum)[keyof typeof CreateAddress200ResponseStatusEnum];
...
export type DeleteClient200ResponseStatusEnum =
  (typeof DeleteClient200ResponseStatusEnum)[keyof typeof DeleteClient200ResponseStatusEnum];
export const DeleteClient200ResponseMsgEnum = {
  ClientDeleted: "client deleted",
} as const;

export type DeleteClient200ResponseMsgEnum =
  (typeof DeleteClient200ResponseMsgEnum)[keyof typeof DeleteClient200ResponseMsgEnum];
...
export type GetAddress302ResponseStatusEnum =
  (typeof GetAddress302ResponseStatusEnum)[keyof typeof GetAddress302ResponseStatusEnum];
...
export type GetMany200ResponseStatusEnum =
  (typeof GetMany200ResponseStatusEnum)[keyof typeof GetMany200ResponseStatusEnum];
...
export type ModelErrorStatusEnum =
  (typeof ModelErrorStatusEnum)[keyof typeof ModelErrorStatusEnum];
...
export type ReturnCreatedClientStatusEnum =
  (typeof ReturnCreatedClientStatusEnum)[keyof typeof ReturnCreatedClientStatusEnum];
...
export type Send200ResponseStatusEnum =
  (typeof Send200ResponseStatusEnum)[keyof typeof Send200ResponseStatusEnum];
 ...
 * @export
 */
export type TransactionSendQueryCluster =
  | BitcoinCluster
  | Cluster
  | EthCluster
  | USDCCluster;
...
export type TxnGetResponseByHashStatusEnum =
  (typeof TxnGetResponseByHashStatusEnum)[keyof typeof TxnGetResponseByHashStatusEnum];
  ...
  return {
    ...
    async createAddress(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<CreateAddress200Response>
    > {
      ...
      const localVarOperationServerBasePath =
        operationServerMap["AddressApi.createAddress"]?.[
    ...
    async getAddress(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<GetAddress302Response>
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["AddressApi.getAddress"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["AddressApi.update"]?.[localVarOperationServerIndex]
          ?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
...
export const AddressApiFactory = function (
  ...
  return {
    ...
    createAddress(
      ...
      return localVarFp
        .createAddress(authorization, addressType, options)
    ...
    getAddress(
      ...
      return localVarFp
        .getAddress(authorization, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Address update endpoint
    ...
    update(
      ...
      return localVarFp
        .update(authorization, addressType, options)
        .then((request) => request(axios, basePath));
    },
  };
};
...
export const ClientApiAxiosParamCreator = function (
  ...
  return {
    ...
    getClient: async (
      ...
      const localVarPath = `/client/{username}`.replace(
        `{${"username"}}`,
  ...
  return {
    ...
    async createClient(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<ReturnCreatedClient>
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["ClientApi.createClient"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async deleteClient(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<DeleteClient200Response>
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["ClientApi.deleteClient"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["ClientApi.getClient"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["ClientApi.login"]?.[localVarOperationServerIndex]
          ?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
    ...
    async me(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.me(
        authorization,
        options,
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["ClientApi.me"]?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
          globalAxios,
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.providerAuth(
        createClient,
        options,
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["ClientApi.providerAuth"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async updateMetadata(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<UpdateMetadata200Response>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.updateMetadata(
        authorization,
        updateMetadataRequest,
        options,
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["ClientApi.updateMetadata"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
...
export const ClientApiFactory = function (
  ...
  return {
    ...
    deleteClient(
      ...
      return localVarFp
        .deleteClient(authorization, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Client get endpoint
    ...
    getClient(
      ...
      return localVarFp
        .getClient(authorization, username, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Client login endpoint
    ...
    providerAuth(
      ...
      return localVarFp
        .providerAuth(createClient, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Client metadata update endpoint
    ...
    updateMetadata(
      ...
      return localVarFp
        .updateMetadata(authorization, updateMetadataRequest, options)
        .then((request) => request(axios, basePath));
    },
  };
};
...
export const MiscellaneousApiFp = function (configuration?: Configuration) {
  const localVarAxiosParamCreator =
    MiscellaneousApiAxiosParamCreator(configuration);
  return {
    /**
     * healthcheck endpoint
     * @param {*} [options] Override http request option.
    ...
    async getHealthCheck(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<HealthCheck>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getHealthCheck(options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["MiscellaneousApi.getHealthCheck"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["MiscellaneousApi.home"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
...
export const TransactionApiAxiosParamCreator = function (
  ...
  return {
    ...
    getMany: async (
      authorization: string,
      txnQuery: GetManyTxnQueryParameter,
      options: RawAxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'authorization' is not null or undefined
    ...
    send: async (
      authorization: string,
      transactionSend: TransactionSendQuery,
  ...
  return {
    ...
    async getAll(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<GetMany200Response>
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["TransactionApi.getAll"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getMany(
        authorization,
        txnQuery,
        options,
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["TransactionApi.getMany"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async getTxn(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<TxnGetResponseByHash>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getTxn(
        authorization,
        txnHash,
        options,
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["TransactionApi.getTxn"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["TransactionApi.send"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
...
export const TransactionApiFactory = function (
  ...
  return {
    ...
    getMany(
      ...
      return localVarFp
        .getMany(authorization, txnQuery, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Transaction get by hash endpoint
    ...
    getTxn(
      ...
      return localVarFp
        .getTxn(authorization, txnHash, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Transaction send endpoint
    ...
    send(
      ...
      return localVarFp
        .send(authorization, transactionSend, sendRequest, options)
        .then((request) => request(axios, basePath));
    },
  };
};
