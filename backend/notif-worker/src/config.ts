...
import {
  ...
  VAPID_PRIVATE_KEY_DEFAULT,
  VAPID_PUBLIC_KEY_DEFAULT,
} from "@paybox/common";
dotenv.config();

export const PORT = process.env.NOTIF_WORKER_PORT || NOTIF_WORKER_PORT;

export const KAFKA_URL = process.env.KAFKA_NOTIF_URL || KAFKA_NOTIF_URL;
