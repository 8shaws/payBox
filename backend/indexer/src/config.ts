...
export const ETH__NODE_API_KEY
    = process.env.ETH_NODE_API_KEY || "";

export const ETH_WS_MAINNET_URL
    = `wss://mainnet.infura.io/ws/v3/${ETH__NODE_API_KEY}`;

export const ETH_WS_SEPOLIA_URL
    = `wss://sepolia.infura.io/ws/v3/${ETH__NODE_API_KEY}`;