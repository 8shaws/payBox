...
export const NOTIF_KAFKA_URL = process.env.NOTIF_KAFKA_URL || KAFKA_NOTIF_URL;

export const NOTIF_KAFKA_ID =
  process.env.NOTIF_KAFKA_ID || KAFKA_NOTIF_CLIENT_ID;

export const CHAT_KAFKA_URL = process.env.CHAT_KAFKA_URL || KAFKA_URL;

export const CHAT_KAFKA_ID = process.env.CHAT_KAFKA_ID || KAFKA_CLIENT_ID;
...
export const SITE_SECRET_KEY = process.env.SITE_SECRET_KEY || "";
