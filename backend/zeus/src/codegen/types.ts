...
export type Mutation_Root = {
  ...
  update_address_book_many?: Maybe<
    Array<Maybe<Address_Book_Mutation_Response>>
  >;
  ...
  update_centralized_txn_many?: Maybe<
    Array<Maybe<Centralized_Txn_Mutation_Response>>
  >;
  ...
  update_client_settings_many?: Maybe<
    Array<Maybe<Client_Settings_Mutation_Response>>
  >;
  ...
  update_notif_to_subs_many?: Maybe<
    Array<Maybe<Notif_To_Subs_Mutation_Response>>
  >;
  ...
  update_notification_subscription_many?: Maybe<
    Array<Maybe<Notification_Subscription_Mutation_Response>>
  >;
