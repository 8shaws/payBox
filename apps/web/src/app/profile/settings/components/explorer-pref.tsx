...
const Explore = ({ pref }: { pref: ExplorerPref }) => {
  ...
  const handleChange = () => {
    if (
      expPref.solExp === pref.solExp &&
      expPref.ethExp === pref.ethExp &&
      expPref.btcExp === pref.btcExp
    ) {
      setOpen(false);
