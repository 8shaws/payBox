...
function ChangePassword() {
    ...
    form.register('confirmPassword', { validate: (value) => value === form.getValues().newPassword });
                                            ...
                                            <FormControl className=''>
                                                <div className="relative w-full">
                                                    ...
                                                    <Button
                                                        ...
                                                        variant={"ghost"}
                                                    >
                                                        {!showNew ? <Eye className="h-4 w-4" /> : <EyeOff className='h-3 w-3' />}
                                                    </Button>
                                                </div>
                                            </FormControl>
                                        </div>
                                            ...
                                            <FormControl className=''>
                                                <div className="relative w-full">
                                                    ...
                                                    <Button
                                                        ...
                                                        variant={"ghost"}
                                                    >
                                                        {!showCon ? <Eye className="h-4 w-4" /> : <EyeOff className='h-3 w-3' />}
                                                    </Button>
                                                </div>
                                            </FormControl>
                                        </div>
