...
import { ClientSignupForm } from "@/src/app/signup/components/user-auth-signup-form";
import { ClientSigninForm } from "@/src/app/signin/user-auth-signin-form";
          ...
          <div className="mx-auto flex w-full flex-col justify-center space-y-6 sm:w-[350px]">
            <div className="flex flex-col space-y-2 text-center">
              ...
              <p className="text-sm text-muted-foreground">
                Enter your email below to login in to you account
              </p>
            </div>
            <ClientSigninForm />
