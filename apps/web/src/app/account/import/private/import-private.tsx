...
export function PrivateKeyForm({ jwt }: { jwt: string }) {
  ...
  const onSubmit = (data: z.infer<typeof ImportAccountSecret>) => {
    const call = async () => {
      ...
      return Promise.resolve({
        status,
        account: (wallet.accounts || {}) as AccountType,
      });
    };
    toast.promise(call(), {
  ...
  return (
    <Card className="w-fit">
      <CardHeader>
        ...
        <CardDescription>
          Add your solana or ethereum account using its private key.
        </CardDescription>
      </CardHeader>
      <Form {...form}>
        <form
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input {...field} required placeholder="Account name..." />
                  </FormControl>
                </FormItem>
              )}
            />
