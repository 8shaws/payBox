...
import { AddressBook, BACKEND_URL, UpdateBook, chains, responseStatus } from '@paybox/common';
...
const BookEdit = ({
    ...
    function onSubmit(data: z.infer<typeof UpdateBook>) {
        ...
        toast.promise(call(), {
            ...
            success: ({ data }) => {
                setBook((old) => old.map((address) => address.id === data.id ? data as AddressBook : address ));
                setOpen(false);
