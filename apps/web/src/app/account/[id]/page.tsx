        ...
        <div className="flex w-full justify-around items-center">
          <Card className="w-fit">
            <CardHeader>
              ...
              <CardDescription>
                Share this for accepting payment...
              </CardDescription>
            </CardHeader>
            ...
            <CardFooter>
              <Share
                ...
                url={`${CLIENT_URL}/txn/accept?to=${params.id}`}
              />
            </CardFooter>
          </Card>
          <Card className="w-[500px] ">
            <CardHeader>
              <CardTitle className="w-[100px] h-[22px] text-start items-center flex">
                {"Account Name" ? (
                  "Account"
                ) : (
                  <Skeleton className="w-[100px] h-[22px]" />
              ...
              <CardDescription>
                Multi chain Web3 Account by Paybox
              </CardDescription>
            </CardHeader>
            <CardContent className="flex flex-col gap-y-4">
              <Tab chain={"Solana"} key={"sol"} net={Network.Sol} />
              <Tab chain={"Ethereum"} key={"eth"} net={Network.Eth} />
              <Tab chain={"Bitcoin"} key={"btc"} net={Network.Bitcoin} />
            </CardContent>
            <CardFooter>
              <p>Footer</p>
            </CardFooter>
