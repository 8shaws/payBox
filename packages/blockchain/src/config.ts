...
export const ETH_RPC_MAINNET_NODE_URL = `https://mainnet.infura.io/v3/${ETH_NODE_API_KEY}`;

export const ETH_RPC_SEPOLIA_NODE_URL = `https://sepolia.infura.io/v3/${SOL_WS_API_KEY}`;
